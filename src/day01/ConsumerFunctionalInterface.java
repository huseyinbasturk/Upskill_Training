...
public class ConsumerFunctionalInterface {
  ...
  public static void main(String[] args) {
    ...
    names.addAll(Arrays.asList("John", "Shay", "Brenna", "Erick"));
    ...
    //Consumer<List<Integer>> multipleBy2 = list -> { }

    numbers.forEach(n -> System.out.println(n * 2));

    System.out.println("--------------------");
    List<String> elements = new ArrayList<>();
    elements.addAll(Arrays.asList("Java", "Java", "Cyber", "Python", "Python"));
